...
require('lazy').setup {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ss', '<cmd>FzfLua<cr>', { desc = '[S]earch [S]elect FzfLua' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
